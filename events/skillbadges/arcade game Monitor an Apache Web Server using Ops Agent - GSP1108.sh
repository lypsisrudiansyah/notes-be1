...
clear
echo "Monitor an Apache Web Server using Ops Agent - GSP1108"


# Foreground Colors (256-color ANSI codes)
BLACK_TEXT=$'\033[38;5;236m'
RED_TEXT=$'\033[38;5;196m'
GREEN_TEXT=$'\033[38;5;46m'
YELLOW_TEXT=$'\033[38;5;220m'
BLUE_TEXT=$'\033[38;5;39m'
MAGENTA_TEXT=$'\033[38;5;201m'
...
echo
echo "${GREEN_TEXT}${BOLD_TEXT}              Donee enenen            ${RESET_FORMAT}"