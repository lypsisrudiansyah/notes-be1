...
clear
echo "Configuring IAM Permissions with gcloud - GSP647"

# Define color variables (24-bit TrueColor RGB Mapping)
BLACK_TEXT=$'\033[38;2;108;117;125m'   # Cool Steel / Slate Gray (readable on dark theme)
RED_TEXT=$'\033[38;2;255;75;75m'        # Coral Neon Red
GREEN_TEXT=$'\033[38;2;0;230;118m'      # Mint Neon / Cyber Green
YELLOW_TEXT=$'\033[38;2;255;184;0m'     # Radiant Warm Gold
BLUE_TEXT=$'\033[38;2;66;133;244m'      # Official Google Blue / Vivid Azure
MAGENTA_TEXT=$'\033[38;2;236;72;153m'   # Cyberpunk Fuchsia / Rose Pink
CYAN_TEXT=$'\033[38;2;0;229;255m'       # Electric High-Contrast Aqua
WHITE_TEXT=$'\033[38;2;248;249;250m'    # Clean Pure Platinum White
...
# Final message
echo
echo "${CYAN_TEXT}${BOLD_TEXT}              Bang jago             ${RESET_FORMAT}"
