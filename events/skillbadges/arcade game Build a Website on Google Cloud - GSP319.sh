...
#
# This script reproduces the manual workflow:
...
#
# It uses the CURRENTLY AUTHENTICATED gcloud account.
# It does NOT ask for/store passwords, API keys, or private keys.
