...
clear
echo "Continuous Delivery with Google Cloud Deploy  || GSP1079 atau GSP1131"


# --- High-Intensity / Bright ANSI Variants ---
BLACK_TEXT=$'\033[0;90m'      # Bright Black / Dark Charcoal
RED_TEXT=$'\033[0;91m'        # Bright / Neon Red
GREEN_TEXT=$'\033[0;92m'      # Bright / Lime Green
YELLOW_TEXT=$'\033[0;93m'     # Bright / Electric Yellow
BLUE_TEXT=$'\033[0;94m'       # Bright / Sky Blue
PURPLE_TEXT=$'\033[0;95m'     # Bright / Magenta-Pink
CYAN_TEXT=$'\033[0;96m'       # Bright / Light Cyan
WHITE_TEXT=$'\033[0;97m'      # High-Intensity Pure White
...
# --- 256-Color Custom Palette (Distinct Shade Remapping) ---
DR_BLUE=$'\033[38;5;33m'      # Vivid Dodger Blue (replaces 27)
DR_CYAN=$'\033[38;5;45m'      # Turquoise / Deep Aqua (replaces 51)
DR_PURPLE=$'\033[38;5;129m'   # Deep Electric Violet (replaces 93)
