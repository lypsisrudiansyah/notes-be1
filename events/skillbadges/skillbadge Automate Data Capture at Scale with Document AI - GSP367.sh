...
clear
echo "Automate Data Capture at Scale with Document AI - GSP367"


gcloud auth list

# getting zone and region
...
echo "Automate Data Capture at Scale with Document AI"
...
#5. Test and validate the end-to-end solution
