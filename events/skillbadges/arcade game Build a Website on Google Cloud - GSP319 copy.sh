...
clear
echo "Build a Website on Google Cloud - GSP319"
...
echo "---------- Task 2: Create GKE cluster ----------"
...
echo "---------- Task 3: Build Orders + Products ----------"
...
echo "---------- Task 4: Deploy Orders + Products ----------"
...
echo "---------- Task 5: Configure + build frontend ----------"
...
echo "---------- Task 6: Build frontend image ----------"
...
printf '\033[1;32mLab automation completed successfully.\033[0m\n'
printf '\033[1;32mFrontend: http://%s\033[0m\n' "$FRONTEND_EXTERNAL_IP"
printf '\033[1;32mOrders:   http://%s/api/orders\033[0m\n' "$ORDERS_EXTERNAL_IP"
printf '\033[1;32mProducts: http://%s/api/products\033[0m\n' "$PRODUCTS_EXTERNAL_IP"
printf '\033[1;32m============================================================\033[0m\n'